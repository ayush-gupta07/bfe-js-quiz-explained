# 📘 JavaScrip- ✅ **One `.md` file per question**, named consistently for easy lookup (`001_promise_order.md`, `002_promise_executor.md`, etc.) Output-Based Interview Questions – BFE.dev Series
